package com.epbooks.www.common.advice;
...
public class CommonControllerAdvice {
	final Logger logger = LoggerFactory.getLogger(CommonControllerAdvice.class);
    ...
    protected ResponseEntity<ErrorResponse> handleBusinessException(final BusinessException e) {
        ...
        logger.info("BusinessException - response>>>>>>>>>>>>>>>>>>>>>>" + response);
    ...
    protected ResponseEntity<ErrorResponse> handleNumberFormatException(NumberFormatException e) {
    	logger.error("handleEntityNotFoundException", e);
        final ErrorResponse response = ErrorResponse.of(ErrorCode.INVALID_FORMAT_VALUE);
