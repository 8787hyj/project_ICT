		...
		<div class="container">
			<div
				...
				<div class="col-md-9 ftco-animate mb-0 text-center">
					...
					<h1 class="mb-0 bread">여행/취미/레저 </h1>
				</div>
			</div>
		</div>
	</section>
						...
						<div class="block-27">
							<ul>
								<c:if test="${booklistbycategory.startPage > 5}">
									<a href="booklist5?pageNo=${booklistbycategory.startPage - 5}">[이전]</a>
								</c:if>
								<c:forEach var="pNo" begin="${booklistbycategory.startPage}"
									end="${booklistbycategory.endPage}">
									<a href="booklist5?pageNo=${pNo}">[${pNo}]</a>
								</c:forEach>
								<c:if
									test="${booklistbycategory.endPage < booklistbycategory.totalPages}">
									<a href="booklist5?pageNo=${booklistbycategory.startPage + 5}">[다음]</a>
								</c:if>
							</ul>
						</div>
					</div>
