...
<body>
				...
				<div class="col-md-9 ftco-animate mb-0 text-center">
					<p class="breadcrumbs mb-0">
						<span class="mr-2"><a href="index.html">Home <i
								class="fa fa-chevron-right"></i></a></span> <span>전체도서 <i
							class="fa fa-chevron-right"></i></span>
					</p>
					<h1 class="mb-0 bread">전체도서 </h1>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="ftco-section ftco-degree-bg">
		<div class="container">
			...
			<c:if test="${booklist.hasBooks()}">
				<div class="row mt-5">
					<div class="col">
						<div class="block-27">
							<ul>
								<c:if test="${booklist.startPage > 5}">
									<a href="booklist?pageNo=${booklist.startPage - 5}">[이전]</a>
								</c:if>
								<c:forEach var="pNo" begin="${booklist.startPage}"
									end="${booklist.endPage}">
									<a href="booklist?pageNo=${pNo}">[${pNo}]</a>
								</c:forEach>
								<c:if test="${booklist.endPage < booklist.totalPages}">
									<a href="booklist?pageNo=${booklist.startPage + 5}">[다음]</a>
								</c:if>
							</ul>
						</div>
					</div>
