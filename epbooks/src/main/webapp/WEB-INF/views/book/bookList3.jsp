						...
						<div class="block-27">
							<ul>
								<c:if test="${booklistbycategory.startPage > 5}">
									<a href="booklist3?pageNo=${booklistbycategory.startPage - 5}">[이전]</a>
								</c:if>
								<c:forEach var="pNo" begin="${booklistbycategory.startPage}"
									end="${booklistbycategory.endPage}">
									<a href="booklist3?pageNo=${pNo}">[${pNo}]</a>
								</c:forEach>
								<c:if
									test="${booklistbycategory.endPage < booklistbycategory.totalPages}">
									<a href="booklist3?pageNo=${booklistbycategory.startPage + 5}">[다음]</a>
								</c:if>
							</ul>
						</div>
					</div>
